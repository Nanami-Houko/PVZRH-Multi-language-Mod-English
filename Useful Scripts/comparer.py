...
compare_json_files('translation_regexs.json', 'translation_regexs_en.json', 'translation_regexs_fr.json')
compare_json_files('translation_strings.json', 'translation_strings_en.json', 'translation_strings_fr.json')